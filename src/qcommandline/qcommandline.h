...
public:
   ...
   * @sa addParam
   */
  void addOption(const QChar &shortName, const QString &longName = QString(),
   ...
   * @sa addParam
   */
  void addSwitch(const QChar &shortName, const QString &longName = QString(),
                 const QString &descr = QString(),
                 QCommandLine::Flags flags = QCommandLine::Optional);
   ...
   * @sa addOption
   */
  void addParam(const QString &name, const QString &descr = QString(),
                QCommandLine::Flags flags = QCommandLine::Optional);
