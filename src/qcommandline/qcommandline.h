...
public:
     ...
     */
    typedef enum {
        Default = 0, /**< can be used for the last line of a
                        QCommandLineConfigEntry[] . */
        Mandatory = 0x01, /**< mandatory argument, will produce a parse error if not
                             present */
        Optional = 0x02, /**< optional argument */
        Multiple = 0x04, /**< argument can be used multiple time and will produce
                            multiple signals. */
        ParameterFence = 0x08, //**< all arguments after this point are considered
     ...
     * QCoreApplication::instance()->arguments() will be called to get the
     * arguments.
     */
    ...
    /**
     * QCommandLine constructor
     * @param app arguments() will be called on this app to get the list of
     * arguments.
     ...
     */
    QCommandLine(
        const QCoreApplication& app, const QCommandLineConfig& config = QCommandLineConfig(), QObject* parent = 0);
     ...
     * @sa addParam
     */
    void addOption(const QChar& shortName, const QString& longName = QString(), const QString& descr = QString(),
     ...
     * @sa addParam
     */
    void addSwitch(const QChar& shortName, const QString& longName = QString(), const QString& descr = QString(),
        QCommandLine::Flags flags = QCommandLine::Optional);
     ...
     */
    void addParam(
        const QString& name, const QString& descr = QString(), QCommandLine::Flags flags = QCommandLine::Optional);

    /**
     * Remove any option of type QCommandLine::Option with a given shortName or
     * longName.
    ...
    /**
     * Remove any option of type QCommandLine::Switch with a given shortName or
     * longName.
     * @param name the name of the option to remove
     * @sa removeOption
     * @sa removeParam
    ...
    /**
     * Remove any option of type QCommandLine::Param with a given shortName or
     * longName.
     * @param name the name of the option to remove
     * @sa removeOption
     * @sa removeSwitch
