...
# All logic classes (TestDetailCode, T, TestDetail, TestGroup, ExpectTestGroup, TAPTestGroup, TestRunner)
# ... (unchanged from previous message; see above for full code)
# Please copy the previous message’s classes for TestDetailCode, T, TestDetail, TestGroup, ExpectTestGroup, TAPTestGroup, TestRunner, and the rest of the script here.
